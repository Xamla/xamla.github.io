...
| conv2_x    | 56x56       | \\( \left[ {\text{3x3, 64} \atop \text{3x3, 64}} \right] \times 2 \\)  | \\( \left[ {\text{3x3, 64} \atop \text{3x3, 64}} \right] \times 3 \\)  | \\( \left[ {\text{1x1, 64} \atop \text{3x3, 64}} \above 0pt \text{1x1, 256} \right] \times 3 \\)    |    |     |
