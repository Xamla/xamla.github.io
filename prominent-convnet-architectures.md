...
|:---------- | :---------: | :----------: | :----------: | :----------: | :-----------: | :-----------: |
| conv1      | 112×112     |              | \\(\hspace{1cm}\\)conv 7x7, 64,\\(\hspace{-1cm}\\) | stride 2
|            | 56x56       |              | \\(\hspace{1cm}\\)3x3 max pool,\\(\hspace{-1cm}\\) | stride 2
...
|            |             |              | \\(\hspace{1cm}\\)average\\(\hspace{-1cm}\\) |  pooling
|            |             |              | \\(\hspace{1cm}\\)1000-d fc\\(\hspace{-1cm}\\)
