...
| conv5_x    | 7x7         |  \\(\left[\text{3x3, 512}\atop\text{3x3, 512}\right] \times 2\\) |  \\(\left[\text{3x3, 512}\atop\text{3x3, 512}\right] \times 3\\) | \\(\left[\text{1x1, 512}\atop{\text{3x3, 512}\atop\text{1x1, 2048}}\right] \times 3\\) | \\(\left[\text{1x1, 512}\atop{\text{3x3, 512}\atop\text{1x1, 2048}}\right] \times 3\\) | \\(\left[ \text{1x1, 512}\atop{ {\scriptstyle \text{3x3, 512}} \atop {\scriptstyle \text{1x1, 2048}} }\right] \times 3\\) |
